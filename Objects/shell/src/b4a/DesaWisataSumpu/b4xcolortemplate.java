...
public static RemoteObject _huebar = RemoteObject.declareNull("b4a.DesaWisataSumpu.b4xcolortemplate._colorpickerpart");
public static RemoteObject _colorpicker = RemoteObject.declareNull("b4a.DesaWisataSumpu.b4xcolortemplate._colorpickerpart");
public static RemoteObject _alphabar = RemoteObject.declareNull("b4a.DesaWisataSumpu.b4xcolortemplate._colorpickerpart");
