...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.DesaWisataSumpu.scrollinglabel.class, "_settext" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_mtext" /*RemoteObject*/ )));
...
Debug.JustUpdateDeviceLine();
_originaltextwidth = __ref.runClassMethod (b4a.DesaWisataSumpu.scrollinglabel.class, "_measuretextwidth" /*RemoteObject*/ ,(Object)(_t),(Object)(__ref.getField(false,"_fnt" /*RemoteObject*/ )));Debug.locals.put("originalTextWidth", _originaltextwidth);Debug.locals.put("originalTextWidth", _originaltextwidth);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.DesaWisataSumpu.scrollinglabel.class, "_stopscrolling" /*RemoteObject*/ );
 }else {
...
Debug.JustUpdateDeviceLine();
_width = __ref.runClassMethod (b4a.DesaWisataSumpu.scrollinglabel.class, "_measuretextwidth" /*RemoteObject*/ ,(Object)(_duplicatetext),(Object)(__ref.getField(false,"_fnt" /*RemoteObject*/ )));Debug.locals.put("Width", _width);Debug.locals.put("Width", _width);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.DesaWisataSumpu.scrollinglabel.class, "_startscrolling" /*void*/ ,(Object)(_p),(Object)(_originaltextwidth));
 };
...
public ResumableSub_StartScrolling(b4a.DesaWisataSumpu.scrollinglabel parent,RemoteObject __ref,RemoteObject _p,RemoteObject _originalwidth) {
this.parent = parent;
this.__ref = __ref;
this._p = _p;
