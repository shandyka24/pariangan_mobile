...
b4xcache._data = RemoteObject.createNew ("b4a.DesaWisataSumpu.b4xorderedmap");__ref.setField("_data",b4xcache._data);
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.getField(false,"_data" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSumpu.b4xorderedmap.class, "_containskey" /*RemoteObject*/ ,(Object)((_key)));
...
RemoteObject _t1 = RemoteObject.declareNull("b4a.DesaWisataSumpu.b4xcache._b4xcacheitem");
...
Debug.JustUpdateDeviceLine();
_t1 = RemoteObject.createNew ("b4a.DesaWisataSumpu.b4xcache._b4xcacheitem");Debug.locals.put("t1", _t1);
...
RemoteObject _ci = RemoteObject.declareNull("b4a.DesaWisataSumpu.b4xcache._b4xcacheitem");
Debug.locals.put("Key", _key);
...
Debug.JustUpdateDeviceLine();
_ci = (__ref.getField(false,"_data" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSumpu.b4xorderedmap.class, "_get" /*RemoteObject*/ ,(Object)((_key))));Debug.locals.put("ci", _ci);Debug.locals.put("ci", _ci);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_data" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSumpu.b4xorderedmap.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"));
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.getField(false,"_data" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSumpu.b4xorderedmap.class, "_getkeys" /*RemoteObject*/ );
...
Debug.JustUpdateDeviceLine();
if (__ref.runClassMethod (b4a.DesaWisataSumpu.b4xcache.class, "_iseternal" /*RemoteObject*/ ,(Object)(_key)).<Boolean>get().booleanValue()) { 
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_data" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSumpu.b4xorderedmap.class, "_put" /*RemoteObject*/ ,(Object)((_key)),(Object)((__ref.runClassMethod (b4a.DesaWisataSumpu.b4xcache.class, "_createb4xcacheitem" /*RemoteObject*/ ,(Object)(_value),(Object)(_key)))));
 BA.debugLineNum = 38;BA.debugLine="TrimIfOversize";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.DesaWisataSumpu.b4xcache.class, "_trimifoversize" /*RemoteObject*/ );
...
Debug.JustUpdateDeviceLine();
_ci = __ref.runClassMethod (b4a.DesaWisataSumpu.b4xcache.class, "_createb4xcacheitem" /*RemoteObject*/ ,(Object)(_value),(Object)(_key));Debug.locals.put("ci", _ci);Debug.locals.put("ci", _ci);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_data" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSumpu.b4xorderedmap.class, "_put" /*RemoteObject*/ ,(Object)((_key)),(Object)((_ci)));
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_data" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSumpu.b4xorderedmap.class, "_remove" /*RemoteObject*/ ,(Object)((_key)));
...
_values = __ref.getField(false,"_data" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSumpu.b4xorderedmap.class, "_getvalues" /*RemoteObject*/ );Debug.locals.put("values", _values);Debug.locals.put("values", _values);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_data" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSumpu.b4xorderedmap.class, "_remove" /*RemoteObject*/ ,(Object)((_ci.getField(true,"Key" /*RemoteObject*/ ))));
 };
 }
}Debug.locals.put("ci", _ci);
;
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.getField(false,"_data" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSumpu.b4xorderedmap.class, "_getsize" /*RemoteObject*/ );
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_data" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSumpu.b4xorderedmap.class, "_remove" /*RemoteObject*/ ,(Object)((((_values.runMethod(false,"Get",(Object)(BA.numberCast(int.class, _i))))).getField(true,"Key" /*RemoteObject*/ ))));
 }
}Debug.locals.put("i", _i);
;
 };
