...
try {
		Debug.PushSubsStack("AddScheme (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,52);
...
try {
		Debug.PushSubsStack("Complete (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,315);
...
try {
		Debug.PushSubsStack("Delete (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,261);
...
Debug.JustUpdateDeviceLine();
_link = __ref.runClassMethod (b4a.DesaWisataSumpu.httpjob.class, "_addscheme" /*RemoteObject*/ ,(Object)(_link));Debug.locals.put("Link", _link);
...
Debug.JustUpdateDeviceLine();
httpjob.__c.runVoidMethod ("LogImpl","98585221",(RemoteObject.concat(RemoteObject.createImmutable("Invalid link: "),httpjob.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((_link))),RemoteObject.createImmutable(""))),0);
...
try {
		Debug.PushSubsStack("Delete2 (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,272);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_req" /*RemoteObject*/ ).runVoidMethod ("InitializeDelete",(Object)(__ref.runClassMethod (b4a.DesaWisataSumpu.httpjob.class, "_escapelink" /*RemoteObject*/ ,(Object)(_link),(Object)(_parameters))));
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e5) {
...
Debug.JustUpdateDeviceLine();
httpjob.__c.runVoidMethod ("LogImpl","98650757",(RemoteObject.concat(RemoteObject.createImmutable("Invalid link: "),httpjob.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((_link))),RemoteObject.createImmutable(""))),0);
 BA.debugLineNum = 278;BA.debugLine="req.InitializeDelete(escapeLink(InvalidURL, Para";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_req" /*RemoteObject*/ ).runVoidMethod ("InitializeDelete",(Object)(__ref.runClassMethod (b4a.DesaWisataSumpu.httpjob.class, "_escapelink" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_invalidurl" /*RemoteObject*/ )),(Object)(_parameters))));
 };
...
try {
		Debug.PushSubsStack("Download (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,219);
...
Debug.JustUpdateDeviceLine();
httpjob.__c.runVoidMethod ("LogImpl","98388613",(RemoteObject.concat(RemoteObject.createImmutable("Invalid link: "),httpjob.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((_link))),RemoteObject.createImmutable(""))),0);
...
try {
		Debug.PushSubsStack("Download2 (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,235);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_req" /*RemoteObject*/ ).runVoidMethod ("InitializeGet",(Object)(__ref.runClassMethod (b4a.DesaWisataSumpu.httpjob.class, "_escapelink" /*RemoteObject*/ ,(Object)(_link),(Object)(_parameters))));
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e5) {
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_req" /*RemoteObject*/ ).runVoidMethod ("InitializeGet",(Object)(__ref.runClassMethod (b4a.DesaWisataSumpu.httpjob.class, "_escapelink" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_invalidurl" /*RemoteObject*/ )),(Object)(_parameters))));
 };
...
try {
		Debug.PushSubsStack("escapeLink (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,246);
...
try {
		Debug.PushSubsStack("GetBitmap (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,330);
...
try {
		Debug.PushSubsStack("GetBitmapResize (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,341);
...
try {
		Debug.PushSubsStack("GetBitmapSample (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,337);
...
try {
		Debug.PushSubsStack("GetInputStream (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,347);
...
try {
		Debug.PushSubsStack("GetRequest (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,310);
...
try {
		Debug.PushSubsStack("GetString (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,291);
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.runClassMethod (b4a.DesaWisataSumpu.httpjob.class, "_getstring2" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("UTF8")));
...
try {
		Debug.PushSubsStack("GetString2 (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,296);
...
try {
		Debug.PushSubsStack("Head (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,119);
...
try {
		Debug.PushSubsStack("Initialize (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,38);
...
try {
		Debug.PushSubsStack("MultipartStartSection (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,179);
...
try {
		Debug.PushSubsStack("PatchBytes (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,97);
...
Debug.JustUpdateDeviceLine();
httpjob.__c.runVoidMethod ("LogImpl","98060940",(RemoteObject.concat(RemoteObject.createImmutable("Invalid link: "),httpjob.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((_link))),RemoteObject.createImmutable(""))),0);
...
try {
		Debug.PushSubsStack("PatchString (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,92);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.DesaWisataSumpu.httpjob.class, "_patchbytes" /*RemoteObject*/ ,(Object)(_link),(Object)(_text.runMethod(false,"getBytes",(Object)(RemoteObject.createImmutable("UTF8")))));
...
try {
		Debug.PushSubsStack("PostBytes (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,63);
...
try {
		Debug.PushSubsStack("PostFile (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,190);
...
Debug.JustUpdateDeviceLine();
httpjob.__c.runVoidMethod ("LogImpl","98323080",RemoteObject.createImmutable("Cannot send files from the assets folder."),0);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.DesaWisataSumpu.httpjob.class, "_postbytes" /*RemoteObject*/ ,(Object)(_link),(Object)(_out.runMethod(false,"ToBytesArray")));
 }else {
...
try {
		Debug.PushSubsStack("PostMultipart (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,133);
...
RemoteObject _fd = RemoteObject.declareNull("b4a.DesaWisataSumpu.httpjob._multipartfiledata");
RemoteObject _in = RemoteObject.declareNull("anywheresoftware.b4a.objects.streams.File.InputStreamWrapper");
Debug.locals.put("Link", _link);
...
Debug.JustUpdateDeviceLine();
_empty = __ref.runClassMethod (b4a.DesaWisataSumpu.httpjob.class, "_multipartstartsection" /*RemoteObject*/ ,(Object)(_stream),(Object)(_empty));Debug.locals.put("empty", _empty);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.DesaWisataSumpu.httpjob.class, "_postbytes" /*RemoteObject*/ ,(Object)(_link),(Object)(_stream.runMethod(false,"ToBytesArray")));
...
try {
		Debug.PushSubsStack("PostString (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,58);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.DesaWisataSumpu.httpjob.class, "_postbytes" /*RemoteObject*/ ,(Object)(_link),(Object)(_text.runMethod(false,"getBytes",(Object)(RemoteObject.createImmutable("UTF8")))));
...
try {
		Debug.PushSubsStack("PutBytes (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,80);
...
Debug.JustUpdateDeviceLine();
httpjob.__c.runVoidMethod ("LogImpl","97929861",(RemoteObject.concat(RemoteObject.createImmutable("Invalid link: "),httpjob.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((_link))),RemoteObject.createImmutable(""))),0);
...
try {
		Debug.PushSubsStack("PutString (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,75);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.DesaWisataSumpu.httpjob.class, "_putbytes" /*RemoteObject*/ ,(Object)(_link),(Object)(_text.runMethod(false,"getBytes",(Object)(RemoteObject.createImmutable("UTF8")))));
...
try {
		Debug.PushSubsStack("Release (httpjob) ","httpjob",12,__ref.getField(false, "ba"),__ref,284);
