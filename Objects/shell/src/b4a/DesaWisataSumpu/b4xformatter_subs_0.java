...
RemoteObject _d = RemoteObject.declareNull("b4a.DesaWisataSumpu.b4xformatter._b4xformatdata");
Debug.locals.put("Data", _data);
...
Debug.JustUpdateDeviceLine();
_d = RemoteObject.createNew ("b4a.DesaWisataSumpu.b4xformatter._b4xformatdata");Debug.locals.put("d", _d);
...
RemoteObject _data = RemoteObject.declareNull("b4a.DesaWisataSumpu.b4xformatter._b4xformatdata");
...
Debug.JustUpdateDeviceLine();
_data = __ref.runClassMethod (b4a.DesaWisataSumpu.b4xformatter.class, "_getformatdata" /*RemoteObject*/ ,(Object)(_number));Debug.locals.put("data", _data);Debug.locals.put("data", _data);
...
Debug.JustUpdateDeviceLine();
_label.runMethod(true,"setText",BA.ObjectToCharSequence(__ref.runClassMethod (b4a.DesaWisataSumpu.b4xformatter.class, "_format" /*RemoteObject*/ ,(Object)(_number))));
...
Debug.JustUpdateDeviceLine();
_d = __ref.runClassMethod (b4a.DesaWisataSumpu.b4xformatter.class, "_createdefaultformat" /*RemoteObject*/ );Debug.locals.put("d", _d);Debug.locals.put("d", _d);
 BA.debugLineNum = 16;BA.debugLine="AddFormatData(d, MIN_VALUE, MAX_VALUE, True)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.DesaWisataSumpu.b4xformatter.class, "_addformatdata" /*RemoteObject*/ ,(Object)(_d),(Object)(BA.numberCast(double.class, __ref.getField(true,"_min_value" /*RemoteObject*/ ))),(Object)(BA.numberCast(double.class, __ref.getField(true,"_max_value" /*RemoteObject*/ ))),(Object)(b4xformatter.__c.getField(true,"True")));
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.runClassMethod (b4a.DesaWisataSumpu.b4xformatter.class, "_copyformatdata" /*RemoteObject*/ ,(Object)(__ref.runClassMethod (b4a.DesaWisataSumpu.b4xformatter.class, "_getdefaultformat" /*RemoteObject*/ )));
