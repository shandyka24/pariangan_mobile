...
if (RapidSub.canDelegate("addstubtoclvifneeded")) { return b4a.DesaWisataSumpu.xuiviewsutils.remoteMe.runUserSub(false, "xuiviewsutils","addstubtoclvifneeded", _ba, _customlistview1, _color);}
...
if (RapidSub.canDelegate("createb4ximageview")) { return b4a.DesaWisataSumpu.xuiviewsutils.remoteMe.runUserSub(false, "xuiviewsutils","createb4ximageview", _ba);}
RemoteObject _iv = RemoteObject.declareNull("b4a.DesaWisataSumpu.b4ximageview");
...
Debug.JustUpdateDeviceLine();
_iv = RemoteObject.createNew ("b4a.DesaWisataSumpu.b4ximageview");Debug.locals.put("iv", _iv);
 BA.debugLineNum = 87;BA.debugLine="iv.Initialize(Null, \"\")";
Debug.JustUpdateDeviceLine();
_iv.runClassMethod (b4a.DesaWisataSumpu.b4ximageview.class, "_initialize" /*RemoteObject*/ ,_ba,(Object)(xuiviewsutils.mostCurrent.__c.getField(false,"Null")),(Object)(RemoteObject.createImmutable("")));
...
if (RapidSub.canDelegate("createlabel")) { return b4a.DesaWisataSumpu.xuiviewsutils.remoteMe.runUserSub(false, "xuiviewsutils","createlabel", _ba);}
...
if (RapidSub.canDelegate("initialize")) { return b4a.DesaWisataSumpu.xuiviewsutils.remoteMe.runUserSub(false, "xuiviewsutils","initialize", _ba);}
;
...
if (RapidSub.canDelegate("performhapticfeedback")) { return b4a.DesaWisataSumpu.xuiviewsutils.remoteMe.runUserSub(false, "xuiviewsutils","performhapticfeedback", _ba, _view);}
...
if (RapidSub.canDelegate("setalpha")) { return b4a.DesaWisataSumpu.xuiviewsutils.remoteMe.runUserSub(false, "xuiviewsutils","setalpha", _ba, _view, _level);}
RemoteObject _jo = RemoteObject.declareNull("anywheresoftware.b4j.object.JavaObject");
...
if (RapidSub.canDelegate("setbitmapandfill")) { return b4a.DesaWisataSumpu.xuiviewsutils.remoteMe.runUserSub(false, "xuiviewsutils","setbitmapandfill", _ba, _imageview, _bmp);}
...
if (RapidSub.canDelegate("settextorcsbuildertolabel")) { return b4a.DesaWisataSumpu.xuiviewsutils.remoteMe.runUserSub(false, "xuiviewsutils","settextorcsbuildertolabel", _ba, _xlbl, _text);}
;
