...
__ref.runClassMethod (b4a.DesaWisataSumpu.roundslider.class, "_createthumb" /*RemoteObject*/ );};
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.DesaWisataSumpu.roundslider.class, "_draw" /*RemoteObject*/ );
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.DesaWisataSumpu.roundslider.class, "_base_resize" /*RemoteObject*/ ,(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getWidth"))),(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getHeight"))));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.DesaWisataSumpu.roundslider.class, "_setvalue" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_mvalue" /*RemoteObject*/ )));
