...
public boolean isSingleton() {
    ...
    static {
        ...
        remoteMe = RemoteObject.declareNull("b4a.DesaWisataSumpu.core");
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("core"), "b4a.DesaWisataSumpu.core");
        RDebug.INSTANCE.eventTargets.put(new DeviceClass("b4a.DesaWisataSumpu.core"), new java.lang.ref.WeakReference<PCBA> (pcBA));
	}
