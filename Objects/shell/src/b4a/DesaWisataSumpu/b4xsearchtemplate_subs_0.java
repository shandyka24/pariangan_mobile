...
b4xsearchtemplate._xdialog = RemoteObject.createNew ("b4a.DesaWisataSumpu.b4xdialog");__ref.setField("_xdialog",b4xsearchtemplate._xdialog);
 //BA.debugLineNum = 6;BA.debugLine="Public SearchField As B4XFloatTextField";
b4xsearchtemplate._searchfield = RemoteObject.createNew ("b4a.DesaWisataSumpu.b4xfloattextfield");__ref.setField("_searchfield",b4xsearchtemplate._searchfield);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_xdialog" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSumpu.b4xdialog.class, "_close" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_xui" /*RemoteObject*/ ).getField(true,"DialogResponse_Positive")));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.DesaWisataSumpu.b4xsearchtemplate.class, "_customlistview1_itemclick" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, 0)),(Object)(__ref.getField(false,"_customlistview1" /*RemoteObject*/ ).runMethod(false,"_getvalue",(Object)(BA.numberCast(int.class, 0)))));
 }}
;
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.DesaWisataSumpu.b4xsearchtemplate.class, "_update" /*RemoteObject*/ ,(Object)(_new),(Object)(b4xsearchtemplate.__c.getField(true,"False")));
...
public ResumableSub_Show(b4a.DesaWisataSumpu.b4xsearchtemplate parent,RemoteObject __ref,RemoteObject _dialog) {
this.parent = parent;
this.__ref = __ref;
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.DesaWisataSumpu.b4xsearchtemplate.class, "_update" /*RemoteObject*/ ,(Object)(BA.ObjectToString("")),(Object)(parent.__c.getField(true,"True")));
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_searchfield" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSumpu.b4xfloattextfield.class, "_settext" /*RemoteObject*/ ,BA.ObjectToString(""));
 BA.debugLineNum = 75;BA.debugLine="SearchField.TextField.RequestFocus";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_searchfield" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSumpu.b4xfloattextfield.class, "_gettextfield" /*RemoteObject*/ ).runVoidMethod ("RequestFocus");
 BA.debugLineNum = 77;BA.debugLine="IME.ShowKeyboard(SearchField.TextField)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_ime" /*RemoteObject*/ ).runVoidMethod ("ShowKeyboard",(Object)((__ref.getField(false,"_searchfield" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSumpu.b4xfloattextfield.class, "_gettextfield" /*RemoteObject*/ ).getObject())));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.DesaWisataSumpu.b4xsearchtemplate.class, "_additemstolist" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_allitems" /*RemoteObject*/ )),(Object)(_str1));
 }else {
