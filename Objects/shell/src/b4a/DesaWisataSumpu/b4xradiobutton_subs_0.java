...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.DesaWisataSumpu.b4xradiobutton.class, "_setvalueimpl" /*void*/ ,(Object)(__ref.getField(true,"_mvalue" /*RemoteObject*/ )),(Object)(b4xradiobutton.__c.getField(true,"True")));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.DesaWisataSumpu.b4xradiobutton.class, "_base_resize" /*RemoteObject*/ ,(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getWidth"))),(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getHeight"))));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.DesaWisataSumpu.b4xradiobutton.class, "_setvalueimpl" /*void*/ ,(Object)(b4xradiobutton.__c.runMethod(true,"Not",(Object)(__ref.getField(true,"_mvalue" /*RemoteObject*/ )))),(Object)(b4xradiobutton.__c.getField(true,"False")));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.DesaWisataSumpu.b4xradiobutton.class, "_setvalueimpl" /*void*/ ,(Object)(_b),(Object)(b4xradiobutton.__c.getField(true,"False")));
...
public ResumableSub_SetValueImpl(b4a.DesaWisataSumpu.b4xradiobutton parent,RemoteObject __ref,RemoteObject _b,RemoteObject _immediate) {
this.parent = parent;
this.__ref = __ref;
this._b = _b;
...
RemoteObject _rb = RemoteObject.declareNull("b4a.DesaWisataSumpu.b4xradiobutton");
...
//if
this.state = 10;
if (RemoteObject.solveBoolean("!",_v,__ref.getField(false,"_mbase" /*RemoteObject*/ )) && RemoteObject.solveBoolean("i",_v.runMethod(false,"getTag"), RemoteObject.createImmutable("b4a.DesaWisataSumpu.b4xradiobutton"))) { 
this.state = 9;
}if (true) break;
...
Debug.JustUpdateDeviceLine();
_rb.runClassMethod (b4a.DesaWisataSumpu.b4xradiobutton.class, "_setchecked" /*RemoteObject*/ ,parent.__c.getField(true,"False"));
 if (true) break;
...
//C
this.state = 23;
__ref.runClassMethod (b4a.DesaWisataSumpu.b4xradiobutton.class, "_draw" /*RemoteObject*/ ,(Object)(BA.numberCast(float.class, 1)));
if (true) break;

case 20:
//C
this.state = 23;
__ref.runClassMethod (b4a.DesaWisataSumpu.b4xradiobutton.class, "_draw" /*RemoteObject*/ ,(Object)(BA.numberCast(float.class, 0)));
if (true) break;
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.DesaWisataSumpu.b4xradiobutton.class, "_draw" /*RemoteObject*/ ,(Object)(_state1));
