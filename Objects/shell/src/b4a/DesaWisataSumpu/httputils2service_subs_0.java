...
try {
		Debug.PushSubsStack("CompleteJob (httputils2service) ","httputils2service",11,httputils2service.processBA,httputils2service.mostCurrent,152);
if (RapidSub.canDelegate("completejob")) { return b4a.DesaWisataSumpu.httputils2service.remoteMe.runUserSub(false, "httputils2service","completejob", _taskid, _success, _errormessage);}
...
httputils2service.mostCurrent.__c.runVoidMethod ("LogImpl","27471110",RemoteObject.concat(RemoteObject.createImmutable("HttpUtils2Service: job completed multiple times - "),_taskid),0);
...
Debug.ShouldStop(16);
_job.runClassMethod (b4a.DesaWisataSumpu.httpjob.class, "_complete" /*RemoteObject*/ ,(Object)(_taskid));
...
try {
		Debug.PushSubsStack("hc_ResponseError (httputils2service) ","httputils2service",11,httputils2service.processBA,httputils2service.mostCurrent,115);
if (RapidSub.canDelegate("hc_responseerror")) { return b4a.DesaWisataSumpu.httputils2service.remoteMe.runUserSub(false, "httputils2service","hc_responseerror", _response, _reason, _statuscode, _taskid);}
RemoteObject _job = RemoteObject.declareNull("b4a.DesaWisataSumpu.httpjob");
...
httputils2service.mostCurrent.__c.runVoidMethod ("LogImpl","27405575",RemoteObject.concat(RemoteObject.createImmutable("HttpUtils2Service (hc_ResponseError): job completed multiple times - "),_taskid),0);
...
try {
		Debug.PushSubsStack("hc_ResponseSuccess (httputils2service) ","httputils2service",11,httputils2service.processBA,httputils2service.mostCurrent,92);
if (RapidSub.canDelegate("hc_responsesuccess")) { return b4a.DesaWisataSumpu.httputils2service.remoteMe.runUserSub(false, "httputils2service","hc_responsesuccess", _response, _taskid);}
RemoteObject _job = RemoteObject.declareNull("b4a.DesaWisataSumpu.httpjob");
...
Debug.ShouldStop(1073741824);
httputils2service.mostCurrent.__c.runVoidMethod ("LogImpl","27274499",RemoteObject.concat(RemoteObject.createImmutable("HttpUtils2Service (hc_ResponseSuccess): job completed multiple times - "),_taskid),0);
...
try {
		Debug.PushSubsStack("Receiver_Receive (httputils2service) ","httputils2service",11,httputils2service.processBA,httputils2service.mostCurrent,58);
if (RapidSub.canDelegate("receiver_receive")) { return b4a.DesaWisataSumpu.httputils2service.remoteMe.runUserSub(false, "httputils2service","receiver_receive", _firsttime, _startingintent);}
...
try {
		Debug.PushSubsStack("Response_StreamFinish (httputils2service) ","httputils2service",11,httputils2service.processBA,httputils2service.mostCurrent,107);
if (RapidSub.canDelegate("response_streamfinish")) { return b4a.DesaWisataSumpu.httputils2service.remoteMe.runUserSub(false, "httputils2service","response_streamfinish", _success, _taskid);}
Debug.locals.put("Success", _success);
Debug.locals.put("TaskId", _taskid);
...
try {
		Debug.PushSubsStack("Service_Create (httputils2service) ","httputils2service",11,httputils2service.processBA,httputils2service.mostCurrent,27);
if (RapidSub.canDelegate("service_create")) { return b4a.DesaWisataSumpu.httputils2service.remoteMe.runUserSub(false, "httputils2service","service_create");}
...
Debug.ShouldStop(2);
httputils2service.mostCurrent.__c.runVoidMethod ("LogImpl","26946823",BA.ObjectToString(httputils2service.mostCurrent.__c.runMethod(false,"LastException",httputils2service.processBA)),0);
 BA.debugLineNum = 35;BA.debugLine="Log(\"Switching to File.DirInternal\")";
Debug.ShouldStop(4);
httputils2service.mostCurrent.__c.runVoidMethod ("LogImpl","26946824",RemoteObject.createImmutable("Switching to File.DirInternal"),0);
...
try {
		Debug.PushSubsStack("Service_Destroy (httputils2service) ","httputils2service",11,httputils2service.processBA,httputils2service.mostCurrent,68);
if (RapidSub.canDelegate("service_destroy")) { return b4a.DesaWisataSumpu.httputils2service.remoteMe.runUserSub(false, "httputils2service","service_destroy");}
...
try {
		Debug.PushSubsStack("Service_Start (httputils2service) ","httputils2service",11,httputils2service.processBA,httputils2service.mostCurrent,64);
if (RapidSub.canDelegate("service_start")) { return b4a.DesaWisataSumpu.httputils2service.remoteMe.runUserSub(false, "httputils2service","service_start", _startingintent);}
Debug.locals.put("StartingIntent", _startingintent);
...
try {
		Debug.PushSubsStack("SubmitJob (httputils2service) ","httputils2service",11,httputils2service.processBA,httputils2service.mostCurrent,74);
if (RapidSub.canDelegate("submitjob")) { return b4a.DesaWisataSumpu.httputils2service.remoteMe.runUserSub(false, "httputils2service","submitjob", _job);}
...
httputils2service._hc.runVoidMethod ("ExecuteCredentials",httputils2service.processBA,(Object)(_job.runClassMethod (b4a.DesaWisataSumpu.httpjob.class, "_getrequest" /*RemoteObject*/ )),(Object)(_taskid),(Object)(_job.getField(true,"_username" /*RemoteObject*/ )),(Object)(_job.getField(true,"_password" /*RemoteObject*/ )));
 }else {
 BA.debugLineNum = 86;BA.debugLine="hc.Execute(job.GetRequest, TaskId)";
Debug.ShouldStop(2097152);
httputils2service._hc.runVoidMethod ("Execute",httputils2service.processBA,(Object)(_job.runClassMethod (b4a.DesaWisataSumpu.httpjob.class, "_getrequest" /*RemoteObject*/ )),(Object)(_taskid));
 };
