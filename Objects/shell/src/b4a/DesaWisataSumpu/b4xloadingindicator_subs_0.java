...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.DesaWisataSumpu.b4xloadingindicator.class, "_mainloop" /*void*/ );
...
public ResumableSub_MainLoop(b4a.DesaWisataSumpu.b4xloadingindicator parent,RemoteObject __ref) {
this.parent = parent;
this.__ref = __ref;
}
